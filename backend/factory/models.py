...
class FactoryMember(models.Model):
    ...
    factory = models.ForeignKey(to=Factory, on_delete=models.CASCADE)
    member = models.ForeignKey(to=Users, on_delete=models.CASCADE)
    status = models.CharField(max_length=10, choices=StatusChoice.choices, default=StatusChoice.ENABLED)
